...
function activateRow(id, status) {
    $.ajax({
        type: 'POST',
        url: BASEPATH + 'achivementController/activateRow',
...
function editRow(rowId) {
    $.ajax({
        type: 'POST',
        url: BASEPATH + 'achivementController/editRow',
        data: { id: rowId },
        cache: false,
        success: function(res) {
            var data = JSON.parse(res);
            ...
            $("#achiv_name").val(data.achiv_name);
            $("#achiv_content").text(data.achiv_content);
...
$('#btnAddRow').click(function() {
    ...
    if (isFormValid) {
        $.ajax({
            url: BASEPATH + 'achivementController/' + controllerAction + '/' + id,
            type: "post",
            data: formData,
            processData: false,
            contentType: false,
...
function getRows() {
    ...
    $('.tblRow').DataTable({
        ...
        "ajax": {
            "url": BASEPATH + 'achivementController/getRows',
            "type": "POST"
        },
...
function deleteRow(rowId) {
    $.ajax({
        type: 'POST',
        url: BASEPATH + 'achivementController/deleteRow',
        data: { id: rowId },
        cache: false,
        success: function(res) {
            console.log(res);
