...
<body class="cbp-spmenu-push" onload="getRows()">
    <div class="main-content">
        ...
        <div id="page-wrapper">
            <div class="main-page">
				<h2 class="title1">Our Achivement</h2>
				<div class="col-md-4">
                            ...
                            <div class="inbox-page">
                                <div class="form-body">
                                    <form name="frmAddRow" id="frmAddRow" action="#" method="post" enctype="multipart/form-data"> 
                                        ...
                                        <div class="form-group"> 
                                            <label for="imageCaption">Achivement Name<span class='mandetory'> * </span></label> 
                                            <input type="text" class="form-control" id="achiv_name" name="achiv_name" placeholder="Enter your achivement"> 
                                        </div>
                                        <div class="form-group"> 
                                            <label for="imageCaption">Description : <span class='mandetory'> * </span></label>
                                            <textarea class="form-control" name="achiv_content" id="achiv_content" rows="2"></textarea> 
                                        </div> 
                                        <div class="form-group"> 
    ...
    <script src="<?php echo base_url('assets/js/achivement.js'); ?>"></script>
</body>
</html>